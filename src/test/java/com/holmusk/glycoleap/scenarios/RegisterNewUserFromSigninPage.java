...
public class RegisterNewUserFromSigninPage extends LaunchEmulatorAndDeployAPK {

	@Test
	public void registerNewUserFromSigninPage() throws Exception{
    		
		   //Launch Page
            By signInBtn = By.id(app_package_name + "btn_sign_in");
            System.out.println("Clicking on Sign in button");
            driver.findElement(signInBtn).click();
 		   //Clicking on registration from sign in page           
